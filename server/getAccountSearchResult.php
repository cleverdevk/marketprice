<?php
 ...
 if(!$mysqli) {
   ...
   $sql0 = "SELECT count(*) as count from accounting where title LIKE '%".$keyword."%' OR content LIKE '%".$keyword."%'";
   ...
   $sql1 = "select * from accounting where title LIKE '%".$keyword."%' OR content LIKE '%".$keyword."%'";
   ...
   $sql2 = "select accounting.no, SUM(IFNULL(cost, 0)) as cost from accounting_elements right outer join accounting on accounting_elements.accountingno = accounting.no where title LIKE '%".$keyword."%' OR content LIKE '%".$keyword."%' group by accounting.no ;";
